...
(current published version: **1.1.0**) receive security fixes.

| Version range | Supported          |
| ------------- | ------------------ |
| 1.1.x         | Yes - current minor |
| 1.0.x         | Yes - previous minor |
| < 1.0.0      | No                 |
...
> https://github.com/TechTideOhio/techtide-harness-kit/security/advisories/new
...
2. **Affected component path** - the file or directory inside this repository
   (for example `skills/aws/techtide-aws-iam-least-privilege-review/skill.md` or
...
- **Agent harnesses and platforms** - Claude Code, Codex, GitHub Copilot, Cursor,
...
2. **GitHub artifact attestations (SLSA Build L3 provenance)** - the release
   ...
   gh attestation verify ./techtide-harness-kit-<version>.tgz \
