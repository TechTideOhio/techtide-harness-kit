...
> Agent for `techtide-huawei-landing-zone-architect`. Set up Huawei Cloud Organizations with SCP baseline, IAM fine-grained permission structure, Enterprise Projects governance model, and master account structure for multi-account/multi-project governance.
...
Use this canonical agent only for `techtide-huawei-landing-zone-architect` work.
