...
> Agent for `techtide-huawei-waf-reliability-review`. Assess Huawei Cloud workload reliability posture via AZ distribution, ELB load balancing, Auto Scaling, GaussDB and RDS multi-AZ HA, and CBR data protection.
...
Use this canonical agent only for `techtide-huawei-waf-reliability-review` work.
