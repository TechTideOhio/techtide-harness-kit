...
> Agent for `techtide-nvidia-triton-inference-serving-review`. Static review of Triton Inference Server deployments against NVIDIA's Triton documentation - model repository layout, dynamic batching, ensemble pipelines, custom backend trust, gRPC/HTTP authentication, model encryption at rest, response cache poisoning surface.
...
Use this canonical agent only for `techtide-nvidia-triton-inference-serving-review` work.
...
Static review of Triton Inference Server deployments against NVIDIA's Triton documentation - model repository layout, dynamic batching, ensemble pipelines, custom backend trust, gRPC/HTTP authentication, model encryption at rest, response cache poisoning surface.
