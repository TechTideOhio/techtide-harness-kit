...
> Agent for `techtide-nvidia-gpu-operator-kubernetes-hardening`. Review NVIDIA GPU Operator deployments on Kubernetes - device plugin, MIG strategy, time-slicing, admission policy for GPU resources, namespace tenancy.
...
Use this canonical agent only for `techtide-nvidia-gpu-operator-kubernetes-hardening` work.

## Required Skill

Before answering, read and follow:

- `skills/nvidia/techtide-nvidia-gpu-operator-kubernetes-hardening/SKILL.md`
