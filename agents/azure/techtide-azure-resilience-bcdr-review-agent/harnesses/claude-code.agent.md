...
description: "Review Azure resilience and disaster-recovery posture for RTO/RPO realism, failover and failback assumptions, shared-responsibility gaps, and recovery runbook or drill quality."
---

# Azure Resilience BCDR Review

Use this agent only for `techtide-azure-resilience-bcdr-review` work.
