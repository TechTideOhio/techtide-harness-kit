...
> Agent for techtide-azure-rbac-review. Review Azure role assignments, custom roles, and scope choices for least privilege and operational safety.
...
Use this canonical agent only for `techtide-azure-rbac-review` work.

## Required Skill

Before answering, read and follow:

- `skills/azure/techtide-azure-rbac-review/SKILL.md`

Load files under `skills/azure/techtide-azure-rbac-review/references/` only when the task needs that reference. Do not dump reference text into the response.
