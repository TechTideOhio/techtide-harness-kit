...
> Agent for `techtide-azure-live-keyvault-rotation-purge-guard`. Guard Key Vault key and secret rotation, soft-delete enforcement, and purge-protection changes, with explicit irreversibility warning before any purge-protection enable.
