...
description: "Investigate Azure Monitor, Log Analytics, Application Insights, alerting, KQL triage, telemetry gaps, and observability workflows with explicit evidence-versus-inference handling."
model: "inherit"
readonly: true
---
...
Use this agent only for `techtide-azure-observability-investigator` work.
