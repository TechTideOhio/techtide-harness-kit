...
> Agent for `techtide-azure-live-app-service-slot-swap-guard`. Guard App Service slot swaps by auditing sticky settings, warmup probe readiness, and swap-with-preview evidence before final swap commit.
