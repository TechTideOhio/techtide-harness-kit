...
> Agent for techtide-azure-ai-foundry-ops-governor. Govern Microsoft Foundry and Azure AI Foundry operations across resource-versus-project boundaries, RBAC, quotas, network isolation, logging, and safe MCP-backed execution.
...
Use this canonical agent only for `techtide-azure-ai-foundry-ops-governor` work.

## Required Skill

Before answering, read and follow:

- `skills/azure/techtide-azure-ai-foundry-ops-governor/SKILL.md`

Load files under `skills/azure/techtide-azure-ai-foundry-ops-governor/references/` only when the task needs that reference. Do not dump reference text into the response.
