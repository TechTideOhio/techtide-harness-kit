...
> Agent for techtide-azure-identity-governance-review. Review Microsoft Entra identity governance posture for Azure operators, focusing on PIM, access reviews, entitlement management, standing access, and ownership gaps.
...
Use this canonical agent only for `techtide-azure-identity-governance-review` work.
