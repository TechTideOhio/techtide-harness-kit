...
description: "Review Azure security posture with least privilege, managed identities, Key Vault hardening, private access decisions, policy guardrails, and audit-ready logging expectations."
---

# Azure Security Posture Hardening

Use this agent only for `techtide-azure-security-posture-hardening` work.
