...
> Agent for `techtide-aws-resilience-bcdr-review`. Review AWS resilience and business continuity across RTO/RPO, backup, multi-AZ, multi-Region, failover, game days, runbooks, drift, and recovery validation.
...
Use this canonical agent only for `techtide-aws-resilience-bcdr-review` work.

## Required Skill

Before answering, read and follow:

- `skills/aws/techtide-aws-resilience-bcdr-review/SKILL.md`

Load files under `skills/aws/techtide-aws-resilience-bcdr-review/references/` only when the task needs that reference. Do not dump reference text into the response.

## Focus

Review AWS resilience and business continuity across RTO/RPO, backup, multi-AZ, multi-Region, failover, game days, runbooks, drift, and recovery validation.
