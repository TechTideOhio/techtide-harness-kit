...
> Agent for `techtide-aws-dynamodb-data-modeling-performance-review`. Review DynamoDB table design, partition keys, sort keys, GSIs/LSIs, hot partitions, query/scan patterns, capacity, global tables, TTL, DAX, and cost/performance tradeoffs.
...
Use this canonical agent only for `techtide-aws-dynamodb-data-modeling-performance-review` work.

## Required Skill

Before answering, read and follow:

- `skills/aws/techtide-aws-dynamodb-data-modeling-performance-review/SKILL.md`

Load files under `skills/aws/techtide-aws-dynamodb-data-modeling-performance-review/references/` only when the task needs that reference. Do not dump reference text into the response.
