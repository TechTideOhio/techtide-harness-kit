...
> Agent for `techtide-aws-landing-zone-governor`. Review AWS multi-account landing zones, Control Tower posture, Organizations structure, OUs, guardrails, logging, audit accounts, and account vending decisions.
...
Use this canonical agent only for `techtide-aws-landing-zone-governor` work.

## Required Skill

Before answering, read and follow:

- `skills/aws/techtide-aws-landing-zone-governor/SKILL.md`

Load files under `skills/aws/techtide-aws-landing-zone-governor/references/` only when the task needs that reference. Do not dump reference text into the response.
