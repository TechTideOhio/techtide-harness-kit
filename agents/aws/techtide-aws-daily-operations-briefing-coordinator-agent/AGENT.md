...
> Agent for `techtide-aws-daily-operations-briefing-coordinator`. Prepare non-destructive AWS daily operations briefings across health signals, incidents, deployments, cost drift, open risks, and action backlog for business and engineering stakeholders.
