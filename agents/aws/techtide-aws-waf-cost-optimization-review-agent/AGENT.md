...
> Agent for `techtide-aws-waf-cost-optimization-review`. Review AWS workload cost posture against the Well-Architected Framework Cost Optimization Pillar: cost visibility, tagging compliance, commitment coverage, rightsizing, Spot adoption, and idle resource identification.
...
Use this canonical agent only for `techtide-aws-waf-cost-optimization-review` work.
