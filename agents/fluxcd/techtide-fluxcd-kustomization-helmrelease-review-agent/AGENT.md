...
> Agent for `techtide-fluxcd-kustomization-helmrelease-review`. Review FluxCD Kustomization, HelmRelease, and source resources for SOPS encryption, source trust, ServiceAccount scoping, prune safety, and HelmRelease upgrade remediation.
...
Use this canonical agent only for `techtide-fluxcd-kustomization-helmrelease-review` work.
