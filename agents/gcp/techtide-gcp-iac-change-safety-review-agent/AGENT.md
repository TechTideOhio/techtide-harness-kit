...
> Agent for techtide-gcp-iac-change-safety-review. Review Terraform and Deployment Manager changes targeting GCP - blast radius analysis, destroy-operation detection, cross-project impact, state file conflicts, org policy drift, and rollback plan completeness.
...
Use this canonical agent only for `techtide-gcp-iac-change-safety-review` work.
