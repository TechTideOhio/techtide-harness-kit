...
> Agent for techtide-gcp-certificate-manager-issuer-review. Review GCP Certificate Manager and classic Google-managed TLS certificates - certificate map configuration, DNS authorization, CAA record validation, certificate rotation automation, wildcard vs SAN design, and expiry monitoring.
...
Use this canonical agent only for `techtide-gcp-certificate-manager-issuer-review` work.
