...
> Agent for `techtide-alibaba-solution-architect`. Design Alibaba Cloud architectures with product selection (PolarDB vs RDS, ACK vs ASK vs SAE, MaxCompute vs AnalyticDB), landing zone design, high availability patterns, and migration planning.
...
Use this canonical agent only for `techtide-alibaba-solution-architect` work.
