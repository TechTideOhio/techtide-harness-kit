...
> Agent for `techtide-alibaba-live-rds-polardb-mutation-guard`. Gate RDS/PolarDB instance deletion, spec downgrade, and backup policy removal - data loss is permanent without backup verification.
...
Use this canonical agent only for `techtide-alibaba-live-rds-polardb-mutation-guard` work.
