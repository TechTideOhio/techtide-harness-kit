...
> Agent for `techtide-alibaba-maxcompute-dataworks-analyst`. Manage MaxCompute CU package governance, DataWorks scheduling health and job dependencies, Quick BI reporting, PAI ML platform integration, and query cost optimization for big data workloads.
...
Use this canonical agent only for `techtide-alibaba-maxcompute-dataworks-analyst` work.
