...
> Advisory agent for Scaleway cost analysis: instance type rightsizing, reserved instance utilization, idle resource detection, Object Storage and SBS spend, Serverless function cost, and Cockpit observability budget.
...
Use this canonical agent only for `techtide-scaleway-cost-optimizer` work.
