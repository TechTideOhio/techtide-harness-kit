...
> Agent for techtide-oci-goldengate-replication-operator. OCI Operate and review Oracle GoldenGate domains, connections, extracts, replicats, checkpoint tables, trails, distribution paths, and replication health. Use for replication setup, lag triage, data movement, and cutover safety.
...
Use this canonical agent only for `techtide-oci-goldengate-replication-operator` work.
