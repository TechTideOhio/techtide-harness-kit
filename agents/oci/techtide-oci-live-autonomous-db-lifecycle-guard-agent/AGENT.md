...
> Agent for `techtide-oci-live-autonomous-db-lifecycle-guard`. Guard Autonomous Database scale, start, stop, clone, and terminate operations with protection-tag check, wallet backup, and connection-string audit before any lifecycle mutation.
