---
name: lovable-security-review
description: "Review Lovable code changes for auth, authorization, injection, secrets, dependency risk, and unsafe defaults. Use when expanding, reviewing, or operating Lovable skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
Review Lovable code changes for auth, authorization, injection, secrets, dependency risk, and unsafe defaults.
