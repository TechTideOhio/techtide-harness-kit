---
name: lovable-cost-aware-routing
description: "Route Lovable and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Lovable skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Lovable Cost Aware Routing

Route Lovable and companion tool work by task risk, context size, model cost, latency, and verification needs.
