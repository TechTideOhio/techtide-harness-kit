---
name: lovable-handoff-readiness-review
description: "Review Lovable session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating Lovable skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Lovable Handoff Readiness Review

Review Lovable session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the Lovable session.
...
5. Never paste private data or production credentials into Lovable prompts or workspace skills.
