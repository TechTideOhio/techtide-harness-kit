---
name: lovable-multi-agent-orchestration
description: "Coordinate Lovable with other agents by splitting work into bounded scopes, clear contracts, integration checks, and review gates. Use when expanding, reviewing, or operating Lovable skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Lovable Multi-Agent Orchestration

Coordinate Lovable with other agents by splitting work into bounded scopes, clear contracts, integration checks, and review gates.
