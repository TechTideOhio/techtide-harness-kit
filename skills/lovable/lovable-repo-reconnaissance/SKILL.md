---
name: lovable-repo-reconnaissance
description: "Use Lovable to map an unfamiliar repository before implementation by finding entrypoints, commands, ownership boundaries, risks, and tests. Use when expanding, reviewing, or operating Lovable skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Lovable Repo Reconnaissance

Use Lovable to map an unfamiliar repository before implementation by finding entrypoints, commands, ownership boundaries, risks, and tests.
