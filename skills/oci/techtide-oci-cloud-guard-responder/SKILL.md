---
name: techtide-oci-cloud-guard-responder
...
Use official-source Oracle OCI docs for Cloud Guard problem, target, detector, responder, and resource vulnerability concepts. Label output docs-based if no live problem feed exists.
