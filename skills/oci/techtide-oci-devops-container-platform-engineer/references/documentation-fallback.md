...
Use this reference when live OCI infrastructure data is unavailable, incomplete, denied, or unsafe to query for `techtide-oci-devops-container-platform-engineer`.
