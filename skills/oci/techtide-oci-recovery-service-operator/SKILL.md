---
name: techtide-oci-recovery-service-operator
...
Use official-source Oracle OCI docs for Recovery Service, Database backups, Data Guard, Monitoring, and IAM. If live recovery feed is unavailable, label output as docs-based and request sanitized backup evidence.
