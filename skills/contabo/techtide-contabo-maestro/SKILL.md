...
- Prefer official Contabo docs (https://api.contabo.com/, https://docs.contabo.com/) and official-source for grounding when live MCP access is unavailable.
...
| Domain | Specialist |
|---|---|
| Contract period analysis, VPS sizing, addon utilization | `techtide-contabo-cost-optimization-analyst` |
| Resource planning, region coverage, instance sizing | `techtide-contabo-capacity-planner` |
| SSH key management, default user policy, firewall posture | `techtide-contabo-security-hardening` |
| VPS/VDS create, reinstall, cancel | `techtide-contabo-live-instance-lifecycle-guard` |
| Object Storage, bucket operations, retention audit | `techtide-contabo-live-storage-operations-guard` |
