---
name: kiro-cost-aware-routing
description: "Route Kiro and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Kiro skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Kiro Cost Aware Routing

Route Kiro and companion tool work by task risk, context size, model cost, latency, and verification needs.
