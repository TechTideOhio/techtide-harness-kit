---
name: kiro-debugging-strategy
description: "Run a disciplined Kiro debugging loop that captures symptoms, isolates reproduction, tests hypotheses, patches narrowly, and verifies the fix. Use when expanding, reviewing, or operating Kiro skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Kiro Debugging Strategy

Run a disciplined Kiro debugging loop that captures symptoms, isolates reproduction, tests hypotheses, patches narrowly, and verifies the fix.
