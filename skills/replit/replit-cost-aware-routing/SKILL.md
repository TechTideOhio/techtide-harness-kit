---
name: replit-cost-aware-routing
description: "Route Replit Agent and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Replit Agent skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Replit Agent Cost Aware Routing

Route Replit Agent and companion tool work by task risk, context size, model cost, latency, and verification needs.
