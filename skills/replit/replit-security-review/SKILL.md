---
name: replit-security-review
description: "Review Replit Agent code changes for auth, authorization, injection, secrets, dependency risk, and unsafe defaults. Use when expanding, reviewing, or operating Replit Agent skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Replit Agent Security Review

Review Replit Agent code changes for auth, authorization, injection, secrets, dependency risk, and unsafe defaults.
