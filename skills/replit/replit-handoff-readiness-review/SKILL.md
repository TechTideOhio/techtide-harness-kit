---
name: replit-handoff-readiness-review
description: "Review Replit Agent session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating Replit Agent skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Replit Agent Handoff Readiness Review

Review Replit Agent session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the Replit Agent session.
...
5. Treat public repl code and app previews as public surfaces unless the project is explicitly private.
