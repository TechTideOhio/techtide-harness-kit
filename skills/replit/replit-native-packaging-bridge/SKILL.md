---
name: replit-native-packaging-bridge
description: "Translate TechTide-authored workflows into the documented Replit Agent packaging surface without pretending every agent uses the same activation model. Use when expanding, reviewing, or operating Replit Agent skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Replit Agent Native Packaging Bridge

Translate TechTide-authored workflows into the documented Replit Agent packaging surface without pretending every agent uses the same activation model.
...
1. Read the Replit Agent target docs and identify the native primitive before writing content.
2. Package skills for project-level Replit Agent use with clear env, deploy, and review gates.
