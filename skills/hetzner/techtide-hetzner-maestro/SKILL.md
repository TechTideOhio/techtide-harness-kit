...
|---|---|
| Cost, idle resources, rightsizing | `techtide-hetzner-cost-optimization-analyst-agent` |
| Firewall rules, LB config, network design | `techtide-hetzner-infrastructure-reviewer-agent` |
| Resource limits, quota, growth planning | `techtide-hetzner-capacity-planner-agent` |
| Firewall rule mutations, attachment changes | `techtide-hetzner-live-firewall-rule-guard-agent` |
| Server creation, deletion, rescale | `techtide-hetzner-live-server-lifecycle-guard-agent` |
