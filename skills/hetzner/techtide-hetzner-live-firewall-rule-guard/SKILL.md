---
name: techtide-hetzner-live-firewall-rule-guard
...
Do NOT use this skill for advisory Firewall review - use `techtide-hetzner-infrastructure-reviewer` for that.
