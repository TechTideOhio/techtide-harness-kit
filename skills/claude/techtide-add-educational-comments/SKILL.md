---
name: techtide-add-educational-comments
...
metadata:
  ...
  eval_fixtures: tests/fixtures/techtide-add-educational-comments/
---
...
```text
[user]
> /techtide-add-educational-comments
[agent]
...
```text
[user]
> /techtide-add-educational-comments #file:output_name.py Comment Detail = 1, Repetitiveness = 1, Line Number = no
```
