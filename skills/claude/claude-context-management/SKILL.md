...
description: "Keep Claude Code sessions from drifting by packaging concise project context, current state, decisions, and verification results. Use when expanding, reviewing, or operating Claude Code skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
Keep Claude Code sessions from drifting by packaging concise project context, current state, decisions, and verification results.
