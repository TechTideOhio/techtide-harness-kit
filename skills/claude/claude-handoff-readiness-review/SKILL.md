---
name: claude-handoff-readiness-review
description: "Review Claude Code session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating Claude Code skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Claude Code Handoff Readiness Review

Review Claude Code session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the Claude Code session.
