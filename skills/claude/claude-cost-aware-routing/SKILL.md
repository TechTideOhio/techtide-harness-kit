---
name: claude-cost-aware-routing
description: "Route Claude Code and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Claude Code skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Claude Code Cost Aware Routing

Route Claude Code and companion tool work by task risk, context size, model cost, latency, and verification needs.
