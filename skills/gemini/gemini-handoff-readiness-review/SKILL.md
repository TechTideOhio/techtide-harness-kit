---
name: gemini-handoff-readiness-review
description: "Review Gemini CLI session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating Gemini CLI skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Gemini CLI Handoff Readiness Review

Review Gemini CLI session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the Gemini CLI session.
...
5. Prefer official Google repositories over third-party Gemini skill tutorials.
