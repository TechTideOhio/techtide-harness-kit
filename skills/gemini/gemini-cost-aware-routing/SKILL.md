---
name: gemini-cost-aware-routing
description: "Route Gemini CLI and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Gemini CLI skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Gemini CLI Cost Aware Routing

Route Gemini CLI and companion tool work by task risk, context size, model cost, latency, and verification needs.
