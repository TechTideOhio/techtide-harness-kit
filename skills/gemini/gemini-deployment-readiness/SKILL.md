---
name: gemini-deployment-readiness
description: "Use Gemini CLI to decide whether an app, feature, or prototype is ready for deployment, rollback, and operational ownership. Use when expanding, reviewing, or operating Gemini CLI skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Gemini CLI Deployment Readiness

Use Gemini CLI to decide whether an app, feature, or prototype is ready for deployment, rollback, and operational ownership.
