---
name: techtide-huawei-obs-storage-steward
...
- OBS public ACL exposes data immediately - any public ACL recommendation must be gated by the techtide-huawei-live-obs-bucket-policy-guard skill.
