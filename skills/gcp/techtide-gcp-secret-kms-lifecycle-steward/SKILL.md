---
name: techtide-gcp-secret-kms-lifecycle-steward
description: Audit and govern Cloud KMS key lifecycles, Secret Manager secrets, CMEK configurations across GCP services (Cloud SQL, BigQuery, GCS, Compute), key rotation schedules, and envelope encryption patterns. Prefer techtide-gcp-iam-least-privilege-review for IAM binding review on KMS keys and techtide-gcp-security-posture-hardening for broad org-level encryption policy gaps.
