---
name: codex-handoff-readiness-review
description: "Review OpenAI Codex session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating OpenAI Codex skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# OpenAI Codex Handoff Readiness Review

Review OpenAI Codex session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the OpenAI Codex session.
...
5. Reference OpenAI Codex docs and local package behavior; quarantine unsupported automatic activation claims.
