---
name: codex-context-management
description: "Keep OpenAI Codex sessions from drifting by packaging concise project context, current state, decisions, and verification results. Use when expanding, reviewing, or operating OpenAI Codex skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# OpenAI Codex Context Management

Keep OpenAI Codex sessions from drifting by packaging concise project context, current state, decisions, and verification results.
