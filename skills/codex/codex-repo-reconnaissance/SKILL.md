---
name: codex-repo-reconnaissance
description: "Use OpenAI Codex to map an unfamiliar repository before implementation by finding entrypoints, commands, ownership boundaries, risks, and tests. Use when expanding, reviewing, or operating OpenAI Codex skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# OpenAI Codex Repo Reconnaissance

Use OpenAI Codex to map an unfamiliar repository before implementation by finding entrypoints, commands, ownership boundaries, risks, and tests.
