---
name: codex-mcp-tool-safety
description: "Review OpenAI Codex tool and MCP usage for credential scope, network egress, mutation risk, logging, and human approval gates. Use when expanding, reviewing, or operating OpenAI Codex skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# OpenAI Codex MCP Tool Safety

Review OpenAI Codex tool and MCP usage for credential scope, network egress, mutation risk, logging, and human approval gates.
