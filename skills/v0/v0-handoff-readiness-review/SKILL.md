---
name: v0-handoff-readiness-review
description: "Review v0 session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating v0 skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# v0 Handoff Readiness Review

Review v0 session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the v0 session.
...
5. Do not claim v0 can validate production security by itself; require repo review after generation.
