---
name: v0-debugging-strategy
description: "Run a disciplined v0 debugging loop that captures symptoms, isolates reproduction, tests hypotheses, patches narrowly, and verifies the fix. Use when expanding, reviewing, or operating v0 skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# v0 Debugging Strategy

Run a disciplined v0 debugging loop that captures symptoms, isolates reproduction, tests hypotheses, patches narrowly, and verifies the fix.
