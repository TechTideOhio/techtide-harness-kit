...
description: "Convert rough prompts, transcripts, and prototype notes into architecture decisions, constraints, interfaces, data flows, and implementation-ready work packages. Use when an agent needs Alex Cinovoj / TechTide live-coding patterns, tool routing, guarded prototype-to-production workflows, or cross-harness prompt/skill adapters."
...
1. Extract nouns as domain objects, verbs as workflows, and warnings as constraints.
2. Separate confirmed requirements from guesses and optional ideas.
3. Map data flows, trust boundaries, storage, integrations, and UI surfaces.
4. Turn the architecture into implementation slices with acceptance criteria.
5. Mark unknowns that require user, schema, or live-system verification.
