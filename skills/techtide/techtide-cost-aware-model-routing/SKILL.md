...
description: "Choose models and coding tools with cost, latency, quota, context size, and task risk in mind while preserving verification and quality requirements. Use when an agent needs Alex Cinovoj / TechTide live-coding patterns, tool routing, guarded prototype-to-production workflows, or cross-harness prompt/skill adapters."
...
Choose models and coding tools with cost, latency, quota, context size, and task risk in mind while preserving verification and quality requirements.
...
1. Estimate task complexity, context size, expected tool calls, and quality bar before selecting a model.
2. Prefer lower-cost lanes for simple classification, formatting, and local edits.
3. Use stronger reasoning lanes for architecture, security, cross-file changes, and high ambiguity.
4. Track quota and latency symptoms and switch lanes when a model is exhausted or underperforming.
5. Record cost-sensitive decisions without storing raw provider keys or private telemetry.
