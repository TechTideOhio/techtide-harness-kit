---
name: vercel-cost-aware-routing
description: "Route Vercel Agent Skills and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Vercel Agent Skills skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Vercel Agent Skills Cost Aware Routing

Route Vercel Agent Skills and companion tool work by task risk, context size, model cost, latency, and verification needs.
