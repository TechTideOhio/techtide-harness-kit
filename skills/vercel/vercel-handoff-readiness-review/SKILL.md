---
name: vercel-handoff-readiness-review
description: "Review Vercel Agent Skills session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations. Use when expanding, reviewing, or operating Vercel Agent Skills skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Vercel Agent Skills Handoff Readiness Review

Review Vercel Agent Skills session output before it enters the durable TechTide repo by checking provenance, tests, security, deployment boundaries, and rollback expectations.
...
1. Inventory changed files, prompts, source references, and assumptions from the Vercel Agent Skills session.
...
5. Quarantine repository imports when the GitHub repository has no license or unclear provenance.
