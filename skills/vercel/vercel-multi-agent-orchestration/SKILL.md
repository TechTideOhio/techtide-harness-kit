---
name: vercel-multi-agent-orchestration
description: "Coordinate Vercel Agent Skills with other agents by splitting work into bounded scopes, clear contracts, integration checks, and review gates. Use when expanding, reviewing, or operating Vercel Agent Skills skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Vercel Agent Skills Multi-Agent Orchestration

Coordinate Vercel Agent Skills with other agents by splitting work into bounded scopes, clear contracts, integration checks, and review gates.
...
1. Decompose work by independent files, modules, or research questions.
2. Assign each lane an owner, inputs, outputs, and no-overlap write scope.
3. Keep the immediate blocker local instead of delegating it away.
4. Integrate by reviewing diffs, reconciling assumptions, and running combined tests.
5. Capture reusable coordination patterns as future skill candidates.
