---
name: techtide-aws-generative-ai-developer
description: Build Amazon Bedrock and serverless generative AI applications using Lambda, API Gateway, Step Functions, EventBridge, S3, DynamoDB, SQS, Guardrails, and IAM. Prefer this for serverless GenAI app design and implementation; prefer techtide-aws-agentcore for AgentCore runtime, techtide-aws-bedrock-agent-security-governor for deep Bedrock security, and techtide-aws-serverless-production-readiness for final operational hardening.
