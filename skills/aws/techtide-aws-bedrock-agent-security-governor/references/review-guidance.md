# Bedrock Agent Security Governor Review Guidance

Deep reference material for `techtide-aws-bedrock-agent-security-governor`. Load this only when executing the full review.
