---
name: cursor-cost-aware-routing
description: "Route Cursor and companion tool work by task risk, context size, model cost, latency, and verification needs. Use when expanding, reviewing, or operating Cursor skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Cursor Cost Aware Routing

Route Cursor and companion tool work by task risk, context size, model cost, latency, and verification needs.
