---
name: cursor-debugging-strategy
description: "Run a disciplined Cursor debugging loop that captures symptoms, isolates reproduction, tests hypotheses, patches narrowly, and verifies the fix. Use when expanding, reviewing, or operating Cursor skills, rules, prompt kits, provider lanes, or generated-code handoffs in the TechTide skill library."
...
# Cursor Debugging Strategy

Run a disciplined Cursor debugging loop that captures symptoms, isolates reproduction, tests hypotheses, patches narrowly, and verifies the fix.
